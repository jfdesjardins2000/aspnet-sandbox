...
', 'https://images.pexels.com/photos/7367/startup-photo.jpg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1', 'web-api-csharp', 'Sameer Saini', '2023-06-14 07:45:30.041', 1);

INSERT INTO BlogPosts (Id, Title, ShortDescription, Content, FeaturedImageUrl, UrlHandle, Author, PublishedDate, IsVisible) 
VALUES ('9449dc77-3fc4-4b72-8c8c-08db6cab4598', 'Reading an Excel File in C#: A Step-by-Step Guide', 'Reading data from Excel files is a common requirement in many applications. In this comprehensive guide, we will walk you through the process of reading an Excel file in C# using the .NET framework', '
## Introduction
...
', 'https://images.pexels.com/photos/590022/pexels-photo-590022.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1', 'read-excel-csharp', 'Sameer Saini', '2023-06-14 07:48:27.031', 1);

INSERT INTO BlogPosts (Id, Title, ShortDescription, Content, FeaturedImageUrl, UrlHandle, Author, PublishedDate, IsVisible) 
VALUES ('061265f3-cdfb-428f-8c8d-08db6cab4598', 'Building a Simple Navigation Bar: A Step-by-Step Guide', 'A navigation bar is an essential component of any website or web application, providing users with easy access to different sections and pages.', '## Introduction
...
', 'https://images.pexels.com/photos/16037283/pexels-photo-16037283/free-photo-of-open-laptop-on-desk.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1', 'html-website-using-chatgpt', 'Sameer Saini', '2023-05-30 22:35:50.623', 1);

INSERT INTO BlogPosts (Id, Title, ShortDescription, Content, FeaturedImageUrl, UrlHandle, Author, PublishedDate, IsVisible) 
VALUES ('81495368-62a1-434c-7268-08db615ccdfb', 'Creating a Simple Calculator Application using ASP.NET Core Console App', 'ASP.NET Core is a powerful framework for building cross-platform web applications. While it is commonly used for developing web applications, ASP.NET Core can also be leveraged to create console applications. In this blog post, we will explore in detail how to create a simple calculator application using ASP.NET Core console app. We will cover the step-by-step process of setting up the project, implementing the calculator logic, and running the application. So, let''s get started!', '## Introduction
...
', 'https://images.pexels.com/photos/1181263/pexels-photo-1181263.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1', 'simple-calculator-app-aspnet-core', 'Sameer Saini', '2023-05-30 23:15:59.057', 1);